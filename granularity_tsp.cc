                           ...
                           unsigned granularity = 100)
{
  ...
  std::cout<<"best_ordering:"<<cities.total_path_distance(best_ordering)<<"\n";
  return best_ordering;
...
Cities::permutation_t threaded_ga_search(const Cities& cities, unsigned iters, unsigned pop_size, double mut_rate, unsigned nthread = 1, unsigned granularity = 100){
  auto best_ordering = Cities::permutation_t(cities.size());
